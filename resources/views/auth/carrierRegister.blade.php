...
<nav class="navbar navbar-expand-lg navbar-light bg-header">
    <div class="container-fluid">
        <div class="logo">Register as a Carrier</div>
    </div>
</nav>
<!-- .Header  -->
<!-- Content  -->
<div id="content">
    <div class="content-wrap page-register">
        ...
        <div class="subsite subsite-with-banner">
            ...
            <form class="form-group" action="{{url('carrierReg')}}" method="post">
                @csrf
                    ...
                    <div class="col">
                        ...
                        <div class="field-group">
                            <select class="form-control" name="carrier">
                                <option selected disabled>Please select type of carrier...</option>
                ...
                <div class="row field-row">
                    <div class="col">
                        ...
                        <div class="field-group">
                            <i class="fas fa-envelope"></i>
                            <input type="text" name="plates" class="form-control with-icon" >
                ...
                <div class="row field-row have-a-account">
                    <div class="col">
                        ...
                        <br>
                        <div class="field-group">
                            Want you goods to be delivered? <a href="{{url('Register')}}"> REGISTER </a>
                        </div>
                    </div>
                </div>
            </form>
