                ...
                <div class="col-md-12">
                    <div class="car-card">
                        ...
                        <div class="cc-right">
                            ...
                            <div class="ccr-row-b">{{$booking->carrier->carrier}}</div>
                            <div class="ccr-row-c">Driver <b>{{$booking->carrier->first_name}} {{$booking->carrier->last_name}}</b></div>
                            <span class="badge badge-primary">{{$booking->distance}}km</span>
