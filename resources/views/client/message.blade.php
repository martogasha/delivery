...
<div id="appCapsule">
    ...
    <div class="message-item">
        <img src="{{asset('assets/img/sample/avatar/avatar2.jpg')}}" alt="avatar" class="avatar">
        <div class="content">
    ...
    <div class="message-item">
        ...
        <div class="content">
            <div class="title">Marry</div>
            <div class="bubble">
                <img src="{{asset('assets/img/sample/photo/1.jpg')}}" alt="photo" class="imaged w160">
            </div>
            <div class="footer">10:40 AM</div>
        </div>
    </div>
    ...
    <div class="message-item">
        <img src="{{asset('assets/img/sample/avatar/avatar4.jpg')}}" alt="avatar" class="avatar">
        <div class="content">
